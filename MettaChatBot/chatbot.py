...
class Chat:
    ...
    def query_db(self, query):
        ...
        the answer to the question only using the information from the documentation and history. Also give the source URL of the information. Don't include the history in the answer. If the answer to the question is not found 
